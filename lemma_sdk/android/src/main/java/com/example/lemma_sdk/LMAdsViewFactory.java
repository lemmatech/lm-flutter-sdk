...
final class LMAdsViewFactory extends PlatformViewFactory {
    ...
    public LMAdsViewFactory(@NonNull AdInstanceManager manager) {
    ...
    private static PlatformView getErrorView(@NonNull final Context context, int adId) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            Log.e(LMAdsViewFactory.class.getSimpleName(), message);
